...
const MagicBento = ({
    ...
    const cardData = [
        ...
        },
        {
            color: '#060010',
            title: 'View Project',
            description: 'Check out the live demo or source code.',
            label: 'Links',
    ...
    return (
        <div className="magic-bento-overlay">
            <button className="magic-bento-close-btn" onClick={onClose} aria-label="Close details">
                <X size={24} />
            </button>
            ...
            <BentoCardGrid gridRef={gridRef}>
                {cardData.map((card, index) => {
                    const isDescriptionString = typeof card.description === 'string';
                    const baseClassName = `magic-bento-card ${textAutoHide && isDescriptionString ? 'magic-bento-card--text-autohide' : ''} ${enableBorderGlow ? 'magic-bento-card--border-glow' : ''}`;
                    const cardProps = {
